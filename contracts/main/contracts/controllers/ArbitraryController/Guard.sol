...
contract Guard is UFarmOwnableUUPS, UFarmCoreLink {
     ...
     * @return True if the method is allowed, false otherwise.
     */
    function isMethodAllowed(bytes32 dapp, address dappAddress, bytes4 method) external view returns (bool) {
        return _isMethodAllowed(dapp, dappAddress, method);
    }
     ...
     * @return True if the method is allowed, false otherwise.
     */
    function _isMethodAllowed(bytes32 dapp, address dappAddress, bytes4 method) internal view returns (bool) {
        return
