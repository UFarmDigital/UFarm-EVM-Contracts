...
abstract contract ChainlinkedOracle is Initializable {
    ...
    function __init__ChainlinkedOracle_unchained(uint256 _chainlinkTimeout) internal virtual onlyInitializing {
        chainlinkTimeout = _chainlinkTimeout;
        emit ChainlinkTimeoutSet(_chainlinkTimeout);
    }

    function _chainlinkLatestRoundData(address _oracle) internal view returns (ChainlinkAnswer memory latestRoundData) {
